...
const calculateScore = async(matchId, setId, gameId, winner) => {
  ...
  return addScoreForTeam(winner, points, gameId, setId, matchId);
};
 ...
 */
const addScoreForTeam = (team, points, gameId, setId, matchId) => {
  ...
  if (team === 1) {
    if (pointToIncrement === '15-0') {
      ...
      return finishGame(1, gameId, setId, matchId);
      ...
      finishGame(1, gameId, setId, matchId);
      return 'game team 1';
    ...
    if (pointToIncrement === '15-0') {
      ...
      finishGame(2, gameId, setId, matchId);
      return 'game team 2';
    } else if (pointToIncrement === '15-15') {
      return '15-30';
    } else if (pointToIncrement === '30-15') {
