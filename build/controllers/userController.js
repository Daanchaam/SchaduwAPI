...
var userController = /** @class */ (function () {
    function userController() {
        ...
        this.registerUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _a, email, password, passwordCheck, displayName, existingUser, salt, passwordHash, newUser, savedUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, email = _a.email, password = _a.password, passwordCheck = _a.passwordCheck, displayName = _a.displayName;
                        // Validation
         ...
         */
        this.assignRoleToUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var role, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, userModel_1.default.findByIdAndUpdate(req.params.id, { role: role })];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
